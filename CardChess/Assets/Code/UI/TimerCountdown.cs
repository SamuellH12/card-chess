...
public class TimerCountdown : MonoBehaviour
{
    ...
    void Start(){
        timerDisplay.GetComponent<Text>().text = "" + (secondsLeft / 60) + ":" + secondsLeft;
    }
    ...
    IEnumerator timerCountdown(){
        ...
        timerDisplay.GetComponent<Text>().text = "" + (secondsLeft / 60) + ":" + secondsLeft; // getting a reference to the timer Display //
